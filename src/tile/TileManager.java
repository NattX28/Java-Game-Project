...
public class TileManager {
    ...
    public TileManager(String pathFile, int[] size, boolean flip, boolean oneRow) {
        ...
        try {
            BufferedImage imgTemp = ImageIO.read(getClass().getResourceAsStream(FileName));
    ...
    public BufferedImage[][][] GetAllTiles() {
        BufferedImage[][][] temp = { this.TileSet, this.TileSetFlip };
        return temp;
    }
